...
// //   return (
// //     <div className="min-h-screen bg-linear-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden relative">
...
// //             <span className="inline-block text-orange-500">S</span>
// //             <span className="inline-block text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-600 ml-2 sm:ml-3 md:ml-4">2</span>
// //             <span className="inline-block text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-600">0</span>
// //             <span className="inline-block text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-600">2</span>
// //             <span className="inline-block text-transparent bg-clip-text bg-linear-to-r from-purple-400 to-pink-600">6</span>
// //           </h1>
// //         </div>
...
// //                     }}
// //                   >
// //                     <div className="absolute inset-0 bg-linear-to-br from-purple-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
...
// //                 }}
// //               >
// //                 <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-linear-to-r from-purple-400 to-pink-600 mb-6">
// //                   Why Participate?
// //                 </h3>
...
// //             className="text-center mb-12 md:mb-16"
// //           >
// //             <span className="inline-block px-6 py-3 rounded-full text-sm sm:text-base font-semibold mb-6 bg-linear-to-r from-orange-600 to-orange-500">
// //               Win Big
// //             </span>
// //             <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4">
...
//       bgGradient: 'from-teal-600/20 to-cyan-500/10'
//     },
//     {
//       icon: Activity,
//       value: '2+',
...
//       color: 'teal',
//       gradient: 'from-teal-600 to-cyan-500',
//       bgGradient: 'rgba(20, 184, 166, 0.05)',
...
//   {
//     question: 'What is CROSSROADS 2026?',
//     answer: 'CROSSROADS 2026 is our college  annual technical and cultural fest featuring a blend of innovation, creativity, and talent. It includes exciting technical events like Project Exhibition, Robo Race, and Poster Presentation, along with cultural competitions such as Dance, Singing, Short Film, and many more.'
//   },
//   {
//     question: 'Who can participate in the fest?',
//     answer: 'Students from all colleges across India can participate in CROSSROADS 2026. Whether you are passionate about coding, robotics, arts, or performing, there s an event for everyone!'
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-teal-950 text-white overflow-hidden relative">
//       <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,var(--tw-gradient-stops))] from-orange-900/20 via-transparent to-teal-900/20"></div>
...
//         <motion.div
//           ref={dateRef}
//           className="mb-6 sm:mb-8 flex items-center gap-2 sm:gap-3 bg-gradient-to-r from-orange-600 via-orange-500 to-orange-600 px-4 sm:px-6 py-2 sm:py-3 rounded-full shadow-lg shadow-orange-600/50"
//           whileHover={{ scale: 1.05 }}
//         >
//           <Calendar className="w-4 h-4 sm:w-5 sm:h-5" />
...
//             <span className="inline-block text-orange-500">D</span>
//             <span className="inline-block text-orange-500">S</span>
//             <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-500 ml-2 sm:ml-3 md:ml-4">2</span>
//             <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-500">0</span>
//             <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-500">2</span>
//             <span className="inline-block text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-cyan-500">6</span>
//           </h1>
//         </div>
...
//             className="bg-gray-900/90 backdrop-blur-xl rounded-[22px] p-4 sm:p-6 md:p-8 lg:p-12"
//             style={{
//               boxShadow: '0 0 60px rgba(249, 115, 22, 0.3), inset 0 0 30px rgba(0, 0, 0, 0.5)',
//             }}
//           >
//             <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-orange-500 text-center mb-6 md:mb-8">
//               Registration Open
...
//                     }}
//                   >
//                     <div className="absolute inset-0 bg-gradient-to-br from-orange-600/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
...
//             className="w-full px-8 py-4 rounded-xl font-semibold text-base sm:text-lg relative overflow-hidden group"
//             style={{
//               background: 'linear-gradient(135deg, rgba(249, 115, 22, 1) 0%, rgba(20, 184, 166, 1) 100%)',
...
//               <span className="text-orange-500">Innovation Competition</span>
//               <span className="text-white"> of the Year</span>
//             </h2>
//           </motion.div>
//           <div className="grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-10">
...
//                 }}
//               >
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-cyan-500 mb-6">
//                   Why Participate?
//                 </h3>
//                 <div className="space-y-4">
//                   {[
...
//                       transition={{ duration: 0.6 }}
//                     >
//                       <stat.icon className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 text-${stat.gradient.includes('orange') ? 'orange' : 'teal'}-400`} />
//                     </motion.div>
...
//                 boxShadow: '0 0 80px rgba(249, 115, 22, 0.4), inset 0 0 40px rgba(249, 115, 22, 0.1)',
//               }}
//             >
...
//                 <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-orange-400 mb-4">
//                   Total Prize Pool
//                 </h3>

//                 <div className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-orange-500 to-yellow-400 mb-6">
//                   ₹1,00,000+
//                 </div>
...
//                     <span className="text-gray-300 font-medium">Certificates</span>
//                   </motion.div>
...
//                     <span className="text-gray-300 font-medium">Goodies</span>
//                   </motion.div>
//                 </div>
//               </div>
//             </div>
...
//                       style={{
//                         background: openFAQ === index
//                           ? 'linear-gradient(135deg, rgba(249, 115, 22, 0.1) 0%, rgba(20, 184, 166, 0.1) 100%)'
//                           : 'rgba(255, 255, 255, 0.02)',
//                         border: `2px solid ${openFAQ === index ? 'rgba(249, 115, 22, 0.3)' : 'rgba(20, 184, 166, 0.2)'}`,
//                       }}
//                     >
//                       <div className="flex items-center justify-between gap-4">
//                         <h3 className="text-base sm:text-lg md:text-xl font-semibold text-white">
...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-950 text-white overflow-hidden relative">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 sm:py-12 flex flex-col items-center justify-center pt-24 sm:pt-20 md:pt-24">
        ...
        <div ref={titleRef} className="text-center mb-8 md:mb-12 px-2">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-tight leading-tight whitespace-nowrap">
            <span className="inline-block text-blue-500">C</span>
            <span className="inline-block text-blue-500">R</span>
            <span className="inline-block text-blue-500">O</span>
            <span className="inline-block text-blue-500">S</span>
            <span className="inline-block text-blue-500">S</span>
            <span className="inline-block text-blue-500">R</span>
            <span className="inline-block text-blue-500">O</span>
            <span className="inline-block text-blue-500">A</span>
            <span className="inline-block text-blue-500">D</span>
            <span className="inline-block text-blue-500">S</span>
            <span className="inline-block text-white ml-2 sm:ml-3 md:ml-4">2</span>
            <span className="inline-block text-white">0</span>
            <span className="inline-block text-white">2</span>
            <span className="inline-block text-white">6</span>
          </h1>
        </div>
      ...
      <section className="relative z-10 py-12 sm:py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-7xl">
          <motion.div
            ...
            className="text-center mb-12 md:mb-16"
          >
            <span className="inline-block px-6 py-3 rounded-full text-sm sm:text-base font-semibold mb-6 bg-linear-to-r from-blue-600 to-blue-500">
              Win Big
            </span>
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black mb-4">
              <span className="text-white">Exciting </span>
          ...
          >
            ...
            >
              <div className="text-center">
                ...
                <h3 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-400 mb-4">
                  Total Prize Pool
                </h3>

                <div className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-black text-white mb-6">
                  ₹1,00,000+
                </div>
