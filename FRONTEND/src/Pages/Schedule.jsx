...
export default function Schedule() {
  ...
  useEffect(() => {
    const eventDate = new Date('2026-02-25T23:59:59+05:30').getTime();
      ...
      <div className="relative z-10 py-8 sm:py-16 lg:py-20 px-3 sm:px-6 lg:px-8 pt-28 sm:pt-36 lg:pt-34">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <span className="inline-block bg-linear-to-r from-orange-400 via-orange-500 to-red-500 bg-clip-text text-transparent drop-shadow-lg">
                EVENT
              </span>
              <span className="inline-block ml-2 sm:ml-3 bg-linear-to-r from-cyan-400 via-blue-500 to-cyan-600 bg-clip-text text-transparent drop-shadow-lg">
                SCHEDULE
              </span>
            </motion.h1>
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-4 bg-linear-to-r from-orange-500/20 via-red-500/20 to-orange-500/20 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-orange-500/50 shadow-xl shadow-orange-500/20"
            >
              ...
              <div className="flex flex-col items-start">
                ...
                <span className="text-base sm:text-lg lg:text-2xl font-black bg-linear-to-r from-orange-400 to-red-400 bg-clip-text text-transparent tracking-tight">
                  {countdown}
                </span>
              </div>
            </motion.div>
            ...
            {Object.keys(schedule).map((day) => (
              ...
              >
                {activeDay === day && (
                  <motion.div
                    layoutId="activeTab"
                    className="absolute inset-0 bg-linear-to-r from-orange-500 via-red-500 to-orange-600"
                ...
                {activeDay === day && (
                  <motion.div
                    className="absolute inset-0 bg-linear-to-r from-orange-500 to-red-500 opacity-50 blur-xl"
          ...
          <div className="relative max-w-6xl mx-auto px-3 sm:px-4">
            <div className="absolute left-2 sm:left-6 lg:left-12 top-0 bottom-0 w-px bg-linear-to-b from-transparent via-orange-500/30 to-transparent hidden sm:block" />
                    ...
                    >
                      <div className="relative shrink-0 z-10">
                        <motion.div
                          ...
                          className="relative"
                        >
                          <div className={`w-10 h-10 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-xl sm:rounded-2xl bg-linear-to-br ${colors.gradient} p-0.5 shadow-2xl ${colors.glow}`}>
                          ...
                          <motion.div
                            ...
                            transition={{ duration: 2, repeat: Infinity }}
                            className={`absolute inset-0 rounded-xl sm:rounded-2xl bg-linear-to-br ${colors.gradient} opacity-30 blur-lg`}
                          />
                        </motion.div>
                      ...
                      <div className="flex-1 min-w-0">
                        <motion.div
                          ...
                          className={`bg-linear-to-br from-zinc-900/90 via-zinc-900/50 to-zinc-800/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl border-2 transition-all duration-500 overflow-hidden ${
                        ...
                        >
                          <div className="p-4 sm:p-6 lg:p-8">
                            ...
                            <h3 className={`text-lg sm:text-2xl lg:text-3xl font-black text-white mb-2 sm:mb-3 lg:mb-4 leading-tight hover:bg-linear-to-r hover:${colors.gradient} hover:bg-clip-text hover:text-transparent transition-all duration-300`}>
                              {event.title}
                            </h3>
                          ...
                          <AnimatePresence>
                            {isExpanded && (
                              <motion.div
                                ...
                                className={`border-t-2 ${colors.border} bg-linear-to-br from-zinc-950/50 to-zinc-900/50 backdrop-blur-sm overflow-hidden`}
                              >
                                <div className="p-4 sm:p-6 lg:p-8">
                                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                                    <motion.div
                                      ...
                                      className={`p-4 sm:p-5 lg:p-6 rounded-xl sm:rounded-2xl bg-linear-to-br ${colors.bg} border ${colors.border} backdrop-blur-sm`}
                                    >
                                    ...
                                    >
                                      ...
                                      <div className="space-y-2 sm:space-y-3">
                                        ...
                                        <motion.div 
                                          ...
                                          className={`flex items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm p-2.5 sm:p-3 lg:p-4 bg-linear-to-r ${colors.gradient} rounded-lg sm:rounded-xl shadow-xl ${colors.glow}`}
                                        >
                          ...
                          <motion.div
                            className={`absolute inset-0 bg-linear-to-r ${colors.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500 pointer-events-none rounded-2xl sm:rounded-3xl`}
                          />
                        </motion.div>
                      </div>
                    </motion.div>
          ...
          >
            <motion.div
              whileHover={{ scale: 1.05 }}
              className="inline-flex items-center gap-2 sm:gap-3 px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3 lg:py-4 bg-linear-to-r from-zinc-900/50 to-zinc-800/50 backdrop-blur-xl rounded-xl sm:rounded-2xl border border-zinc-700/50 shadow-xl"
            >
              <Trophy className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-orange-400 shrink-0" />
              <span className="font-black text-xs sm:text-sm lg:text-base bg-linear-to-r from-orange-400 to-cyan-400 bg-clip-text text-transparent">
